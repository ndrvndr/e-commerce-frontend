                ...
                <div class="mt-6">
                    <UCard class="text-sm">
                        <template v-if="!authReady">
                            <USkeleton class="h-5 w-1/2 max-w-32" />
                            <USkeleton class="h-5 w-16 mt-4" />
                            <USkeleton class="h-5 w-2/3 mt-0.5 max-w-44" />
                        </template>
                        <template v-else>
                    ...
                    <UCard class="mt-6 text-sm">
                        ...
                        >
                            <template v-if="status === 'idle' || pending">
